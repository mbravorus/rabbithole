...
const server = new McpServer(
  { name: "rabbithole", version: "0.1.0" },
  {
    instructions: [
      ...
      "4. The final answer_branch remains blocked as the single background listener for the next real canvas event.",
      ...
      "Branch requests may include 'notes': the human's own margin notes and standalone canvas notes.",
